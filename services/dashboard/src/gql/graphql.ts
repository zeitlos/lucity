...
export type Service = {
  ...
  replicas: ReplicaCount;
  resources: Resources;
  secretScanReports: Array<SecretScanReport>;
  sourceUrl: Scalars['String']['output'];
...
export type SecretScanReportsQueryVariables = Exact<{
  id: Scalars['ServiceID']['input'];
}>;


export type SecretScanReportsQuery = { __typename?: 'Query', service: { __typename?: 'Service', id: string, secretScanReports: Array<{ __typename?: 'SecretScanReport', scanner: string, commit: string, scannedAt: string, findings: Array<{ __typename?: 'SecretFinding', rule: string, file: string, line: number, commit: string, secret: string, author?: string | null }> }> } };
