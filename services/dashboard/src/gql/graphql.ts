...
export type EnvironmentDetailsQueryVariables = Exact<{
  environment: Scalars['EnvironmentID']['input'];
}>;


export type EnvironmentDetailsQuery = { __typename?: 'Query', environment: { __typename?: 'Environment', id: string, services: Array<{ __typename?: 'Service', id: string, defaultCommand: string }>, volumes: Array<{ __typename?: 'Volume', id: string, size: string, metrics: Array<{ __typename?: 'MetricSeries', points: Array<{ __typename?: 'MetricPoint', value?: number | null }> }> }> } };
