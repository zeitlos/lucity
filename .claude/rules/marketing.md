...
It's fine to throw some playful shade on Railway, Heroku, Render, Fly.io, and Coolify. But the underlying attitude is: the PaaS market is big enough for more than one solution. The key differentiator is ejectability: no lock-in, standard tools, your infrastructure is always yours.
...
- Vague promises. Be specific about what the platform does
