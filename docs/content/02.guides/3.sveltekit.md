...
For anything that comes from a Lucity [reference](/variables), a database URL or bucket credentials, use `$env/dynamic/private`. Those values can change without your code changing, and a build-time import would freeze whatever was true when the image was made.
