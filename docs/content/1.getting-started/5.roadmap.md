...
- **Eject while suspended.** Even if your workspace is suspended (e.g. for non-payment), you can still eject your infrastructure. Your data is yours, always.
::
...
- **API rate limiting and query cost controls.** Rate limiting on the GraphQL API plus complexity and cost limits per query to prevent abuse and runaway requests.
::
