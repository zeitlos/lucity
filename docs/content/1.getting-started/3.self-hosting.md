...
gateway:
  ...
  name: lucity-gateway
  # Custom domains attach their own listeners as ListenerSet objects in the
  # environment namespace. Without this the Gateway accepts none of them.
  allowedListeners:
    namespaces:
      from: Selector
      selector:
        matchExpressions:
          - key: lucity.dev/workspace
            operator: Exists
  listeners:
    - name: platform-https
      protocol: HTTPS
