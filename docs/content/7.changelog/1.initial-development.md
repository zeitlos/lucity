...
From empty repository to a working PaaS in eight days. Here's everything that shipped during the initial development sprint.
...
- **Zero-config builds** via railpack — supports Node.js, Go, Python, Ruby, Java, and more out of the box
