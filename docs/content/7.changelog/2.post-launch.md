...
description: Features shipped since the initial development sprint.
navigation:
  icon: i-lucide-package-check
---

Features and improvements shipped after the initial development sprint (February 16-23, 2026).
