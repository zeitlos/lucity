...
func (c *packagerServiceClient) SetSuspended(ctx context.Context, in *SetSuspendedRequest, opts ...grpc.CallOption) (*SetSuspendedResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SetSuspendedResponse)
	err := c.cc.Invoke(ctx, PackagerService_SetSuspended_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedPackagerServiceServer) SetSuspended(context.Context, *SetSuspendedRequest) (*SetSuspendedResponse, error) {
...
func _PackagerService_SetSuspended_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SetSuspendedRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PackagerServiceServer).SetSuspended(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PackagerService_SetSuspended_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PackagerServiceServer).SetSuspended(ctx, req.(*SetSuspendedRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var PackagerService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _PackagerService_SetSuspended_Handler,
		},
	},
